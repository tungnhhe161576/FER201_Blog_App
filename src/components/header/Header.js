...
import { GrUserSettings, GrCompass } from "react-icons/gr"
                    ...
                    <>
                        ...
                        {profileOpen && (
                            <div className='openProfile boxItems' onClick={close}>
                                ...
                                <Link to='/changepass' className="d-flex justify-content-center">
                                    <button className='box '>
                                        <GrCompass className='icon' />
                                        <h4>Password</h4>
                                    </button>
                                </Link>
                                <Link to='/changeinfo' className="d-flex justify-content-center">
                                    <button className='box '>
